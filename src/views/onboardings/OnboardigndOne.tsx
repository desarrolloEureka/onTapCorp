    ...
    <SafeAreaView>
      ...
      <View style={{height: '100%', width: '100%', position: 'absolute'}}>
        ...
        <View style={{height: '25%', width: '100%', alignItems: 'center'}}>
          <View
            style={{height: '50%', width: '90%', justifyContent: 'flex-start'}}>
            <Text style={{fontSize: 16, color: 'white', textAlign: 'justify'}}>
              Dile adiós a las tarjetas de presentación en papel y dale la
              bienvenida a One Tap, la tarjeta de presentación digital que está
              revolucionando la forma en que compartes tu información.
            </Text>
          </View>
          <View
            style={{
