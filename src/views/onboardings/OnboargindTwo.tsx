    ...
    <SafeAreaView>
      ...
      <View style={{height: '100%', width: '100%', position: 'absolute'}}>
        ...
        <View style={{height: '25%', width: '100%', alignItems: 'center'}}>
          <View
            style={{height: '55%', width: '93%', justifyContent: 'flex-start'}}>
            <Text style={{fontSize: 13, color: 'white', textAlign: 'justify'}}>
              Tu información siempre al día. {'\n'}Nunca más te preocupes por
              tener tu información desactualizada. Con One Tap, mantén tus datos
              siempre al día, puedes modificarlos en cualquier momento, y se
              actualizarán al instante tanto desde la aplicación móvil como a
