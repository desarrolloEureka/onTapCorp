...
import { SafeAreaView, Text, TouchableOpacity, View, FlatList, Image, ImageBackground } from 'react-native';
      ...
      >
        <View style={{ height: 150, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ height: '50%', width: '100%', flexDirection: 'row' }}>
            <View style={{ height: '100%', width: '20%', flexDirection: 'row' }}>
              <View style={{ height: '95%', width: '65%', justifyContent: 'center', alignItems: 'flex-end', marginLeft: 14, marginTop: 3 }}>
                <Image
                  resizeMode='contain'
            ...
            <View style={{ height: '100%', width: '60%', alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
              <View style={{ height: '100%', width: '40%', justifyContent: 'center', alignItems: 'center' }}>
                <TouchableOpacity style={{ height: '94%', width: '95%', justifyContent: 'center', alignItems: 'center' }} onPress={copyToClipboard}>
                  <Text style={{ fontSize: 11, fontWeight: 'bold', color: '#396593' }}>Copiar URL</Text>
            ...
            <View style={{ height: '100%', width: '50%', justifyContent: 'center' }}>
              <View style={{ backgroundColor: 'white', height: '55%', width: '58%', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                <Text style={homeStyles.buttonText}>
                  <Icon name="eye" size={19} color="#030124" />   {user ? user.views : ''}
                </Text>
              </View>
            </View>

            <View style={{ height: '100%', width: '50%', flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
        ...
        <View style={{ height: 60, width: '100%', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ height: "100%", width: '100%', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 22, fontWeight: '500', color: '#396593', }}>Plantillas</Text>
          </View>
        </View>
            ...
            {templates &&
              <FlatList
                ...
                renderItem={({ item, index }) => {
                  const i = item.id;
                  const itemData = user?.templateData?.find((val) => val.id === i);
                  const background = user?.templateData?.find((val) => val.id === i && val.background_id);

                  return (
                    <View style={{ height: 280, width: "50%", justifyContent: 'center', alignItems: 'center' }}>
                      <View style={{ height: "95%", width: "95%", backgroundColor: "#FFFFFF", borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}>
                        <View style={{ height: "20%", width: "100%", alignItems: 'flex-end', flexDirection: 'row' }}>
                          <View style={{ height: "100%", width: "50%", justifyContent: 'center' }}>
                            <TouchableOpacity disabled={itemData ? !itemData?.checked : true} style={{ height: "100%", width: "60%", justifyContent: 'center', alignItems: 'center' }} onPress={() => handleNavigatePreview(background)}>
                              <Ionicons name="eye-sharp" size={15} color="#030124" />
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#E9E9E9', height: 90, position: 'absolute', bottom: 0, width: '100%' }}>
          ...
          <TouchableOpacity style={{ height: "100%", width: "25%", alignItems: 'center', justifyContent: 'center' }} onPress={() => handleTabPress('Profile')}>
            <Ionicons name="person-outline" size={25} color='#606060' />
            <Text style={{ color: '#606060' }}>Empleado</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{ height: "100%", width: "25%", alignItems: 'center', justifyContent: 'center' }} onPress={() => handleTabPress('Meetings')}>
            <Ionicons name="person-outline" size={25} color='#606060' />
